...
export const ProductModal: React.FC<ProductModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-xl max-h-[92dvh] flex flex-col overflow-hidden my-auto border border-neutral-800">
        {/* Modal Header */}
      ...
      {/* Mobile / Webcam Barcode Scanner Modal */}
      <BarcodeScannerModal
        ...
        subtitle="Apunta la cámara del celular al código de barras físico del producto"
        mode="single"
      />
    </div>
  );
